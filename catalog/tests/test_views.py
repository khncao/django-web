...
class AuthorCreateViewTest(TestCase):
    ...
    def test_database_created_author_first_last_name_on_success(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        response = self.client.post(reverse('catalog:author_create'), {'first_name':'test_author_firstName', 'last_name':'test_author_lastName'})
        
        created_author = Author.objects.get(pk=1)
        self.assertEquals('test_author_firstName', created_author.first_name)
        self.assertEquals('test_author_lastName', created_author.last_name)
